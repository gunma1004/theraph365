...
<head>
    ...
    <title>{loc_full} 출장마사지 - 24시 프리미엄 힐링 홈케어 | 테라피365</title>
    <link rel="canonical" href="{canonical_url}">
    <meta name="description" content="{loc_full} 전지역 24시간 출장마사지 추천. 30분 내 신속 방문 및 100% 후불제 안심 케어.">
    <meta name="keywords" content="{loc_full} 출장마사지, {loc_full} 홈타이, 테라피365">
    <meta name="robots" content="index, follow">
    
    <meta property="og:type" content="website">
    <meta property="og:title" content="{loc_full} 출장마사지 | 24시 프리미엄 홈케어 - 테라피365">
    <meta property="og:description" content="{loc_full} 전지역 24시간 출장마사지 추천. 30분 내 신속 방문.">
...
for city_folder, (city_kr, gus) in CITY_MAP.items():
    ...
    gu_links_html = "".join([f'<a href="{link}" class="gu-item">{name} 출장마사지</a>\n            ' for link, name in gus])
...
print(f"🎉 총 {total_count}개 경기/인천 전체 서브페이지 ('지역명 출장마사지' 형식 적용 + 5개 업체 + 테라피365 브랜드) 빌드 완료!")