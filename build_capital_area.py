...
# <title> 및 <meta description>에 단독 '출장마사지'를 완전히 제거하고 {k1}, {k2} 변수 적용
HTML_TEMPLATE = """<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{loc_full} {k1} 1등 힐링 테라피 | 테라피365</title>
    <link rel="canonical" href="{canonical_url}">
    <meta name="description" content="{loc_full} 전지역 24시간 {k1} & {k2} 추천 TOP 5 안내. 30분 내 신속 방문 및 100% 후불제 안심 케어.">
    ...
    <meta property="og:description" content="{loc_full} 전지역 24시간 {k1} & {k2} 추천 TOP 5 안내. 30분 내 신속 방문.">
