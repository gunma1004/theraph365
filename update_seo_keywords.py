...
# ==============================================================================
# 3. 단독 '출장마사지' 완전 배제 30종 최적화 타이틀 템플릿
# ==============================================================================
TITLE_TEMPLATES = [
    "{loc} {k1} 24시 VIP 홈케어 & 프리미엄 스파 - 테라피365",
    "프라이빗 1:1 {loc} {k1} 신속 방문 케어 :: 테라피365",
    "{loc} {k1} 추천 · 뭉친 근육을 푸는 호텔식 {k2} (테라피365)",
    "지친 하루를 위한 {loc} {k1} 30분 도착 보장 | 테라피365",
    "{loc} {k1} & {k2} 24시간 안심 후불제 솔루션 | 테라피365",
    "스트레스 완화 & 림프 순환 전문 {loc} {k1} [테라피365]",
    "{loc} {k1} 직장인 야근 피로 녹이는 감성 {k2} - 테라피365",
    "내 집에서 즐기는 {loc} {k1} VIP 바디 테라피 (테라피365)",
    "{loc} {k1} 전문 테라피스트 1:1 방문 코스 비교 | 테라피365",
    "품격 있는 휴식의 기준, {loc} {k1} & 24시 홈스파 (테라피365)",
    "{loc} {k1} 믿을 수 있는 정찰제 아로마 힐링 케어 | 테라피365",
    "선입금 없는 100% 현장 결제 {loc} {k1} 신속 배차 - 테라피365",
    "{loc} {k1} & {k2} 스페셜 콤보 코스 | 테라피365",
    "도심 속 완벽한 쉼표 {loc} {k1} 24시간 방문 테라피 :: 테라피365",
    "{loc} {k1} 숙련된 베테랑 관리사의 섬세한 케어 [테라피365]",
    "{loc} {k1} 새벽·야간 언제든 예약 가능한 {k2} (테라피365)",
    "지친 일상에 활력을 채우는 {loc} {k1} 딥티슈 힐링 | 테라피365",
    "{loc} {k1} 호텔급 최고급 에센셜 오일 테라피 - 테라피365",
    "어디서나 30분 내 도착 {loc} {k1} & 프리미엄 {k2} | 테라피365",
    "{loc} {k1} 고객 만족도 1위 검증 제휴 매장 TOP 5 :: 테라피365",
    "{loc} {k1} 프라이빗 룸케어 실시간 안심 예약 (테라피365)",
    "부드러운 손길의 감성 릴렉싱 {loc} {k1} 24시 | 테라피365",
    "{loc} {k1} 전신 밸런싱 & 피로회복 집중 솔루션 - 테라피365",
    "깨끗한 1회용 위생용품 완비 {loc} {k1} 안심 방문 [테라피365]",
    "{loc} {k1} 24시간 언제나 열려있는 힐링 플랫폼 (테라피365)",
    "하루의 피로를 상쾌하게 비우는 {loc} {k1} 1:1 케어 | 테라피365",
    "{loc} {k1} 합리적인 가격의 고품격 {k2} 코스 - 테라피365",
    "남녀노소 누구나 편안한 {loc} {k1} 24시 맞춤 홈케어 (테라피365)",
    "{loc} {k1} 실시간 빠른 배정 & VIP 바디 힐링 안내 :: 테라피365",
    "365일 지친 당신을 위한 {loc} {k1} 전문 플랫폼 | 테라피365"
]

# ==============================================================================
# 4. 단독 '출장마사지' 완전 배제 30종 설명(Description) 템플릿
# ==============================================================================
DESC_TEMPLATES = [
    "{loc} {k1} 24시간 안심 후불제 테라피365! {k2} 및 {k3} 1:1 맞춤 힐링.",
    "지친 하루를 채우는 {loc} {k1}. 숙련된 전문 테라피스트가 30분 내 계신 곳으로 찾아갑니다.",
    "{loc} {k1} 전지역 24시 신속 방문 케어. {k2}와 림프 순환 케어를 만나보세요.",
    "선입금 없는 100% 현장 결제 {loc} {k1} 테라피365! 뭉친 근육을 시원하게 풀어드립니다.",
    "{loc} {k1} 직장인 야근 피로회복 24시간 방문 테라피. 철저한 위생 관리와 {k2} 정찰제 운영.",
    "호텔식 프리미엄 바디 테라피를 집에서! {loc} {k1} & {k2} 전문 플랫폼 테라피365입니다.",
    "{loc} {k1} 1:1 맞춤형 딥티슈 & 림프 힐링 솔루션. 전화 한 통으로 신속하게 배차됩니다.",
    "피로에 지친 당신을 위한 {loc} {k1} 24시 홈케어. {k2} 스페셜 코스를 경험해보세요.",
    "{loc} {k1} 전 구역 30분 내 빠른 도착 보장! 전문 자격 관리사의 {k2} 안내.",
    "청결한 1회용 비품 완비 {loc} {k1} 안심 방문. 내 공간에서 누리는 가장 안락한 {k2} 타임.",
    "{loc} {k1} 24시간 실시간 예약 테라피365. {k2}부터 전신 스트레칭까지 완벽 케어.",
    "야간·새벽 언제든 이용 가능한 {loc} {k1} 24시. 검증된 TOP 5 제휴 매장의 정직한 {k2} 안내.",
    "{loc} {k1} 인근 20~30분 신속 방문! 부드러운 {k2}로 스트레스를 날려보세요.",
    "믿고 찾는 {loc} {k1} 1위 테라피365. 섬세한 압 조절과 {k2} 맞춤 컨디셔닝으로 고객 만족 보장.",
    "{loc} {k1} 전지역 당일 신속 배차! 시그니처 {k2}와 VIP 림프 케어로 몸을 리프레시하세요.",
    "내 집에서 즐기는 극상의 힐링 {loc} {k1}. {k2} 합리적인 정찰제 요금으로 안심하고 예약하세요.",
    "{loc} {k1} 1:1 맞춤형 바디 테라피. 전문 관리사의 세심한 손길로 {k2} 프로그램을 제공합니다.",
    "365일 쉬지 않는 {loc} {k1} 24시간 프리미엄 동반자 테라피365! {k2} 방문 케어 안내.",
    "{loc} {k1} 최고급 천연 에센셜 오일 사용! 피부 보습과 근육 이완을 선사하는 {k2}.",
    "선입금 사기 걱정 없는 100% 후불 결제 {loc} {k1}. 언제 어디서나 {k2}를 안심하고 이용하세요.",
    "{loc} {k1} 직장인 단골 재이용률 상위 매장 안내. {k2} 1:1 상담과 빠른 배정을 지원합니다.",
    "프라이빗한 나만의 공간에서 즐기는 {loc} {k1} 24시. 최상의 {k2} 코스를 제안합니다.",
    "{loc} {k1} + {k2} 콤보 스페셜 프로그램. 숙련된 테라피스트의 손길을 느껴보세요.",
    "번거로운 이동 없이 자택에서 만나는 {loc} {k1}. 지친 일상에 {k2}로 활력을 불어넣어 드립니다.",
    "{loc} {k1} 전 구역 신속 배차 네트워크 테라피365! 정직한 가격과 {k2} 서비스로 모십니다.",
    "체형과 컨디션에 맞춘 {loc} {k1} 1:1 솔루션. 전문 테라피스트가 직접 방문하여 {k2}를 진행합니다.",
    "{loc} {k1} 24시간 운영 방문 테라피. 스트레스 해소와 숙면을 돕는 {k2} 완비.",
    "깨끗하고 안전한 {loc} {k1} 예약 플랫폼. 테라피365에서 검증된 {k2} 제휴처를 확인하세요.",
    "{loc} {k1} 맞춤형 전신 바디 밸런싱. 부드러운 {k2}로 긴장을 풀어드립니다.",
    "도심 속 최고의 휴식처 {loc} {k1} 24시 테라피365! 지금 바로 {k2} 실시간 예약을 문의하세요."
]
...
for root, dirs, files in os.walk("."):
    ...
    for file in files:
        ...
        new_title = random.choice(TITLE_TEMPLATES).format(loc=loc_name, k1=k1, k2=k2, k3=k3, k4=k4)
        new_desc = random.choice(DESC_TEMPLATES).format(loc=loc_name, k1=k1, k2=k2, k3=k3, k4=k4)
        new_keywords = f"{loc_name} {k1}, {loc_name} {k2}, {loc_name} {k3}, 테라피365, 24시 방문 홈케어, {k4}"
        new_og_title = f"{loc_name} {k1} & 24시 프리미엄 힐링 테라피 | 테라피365"
...
print(f"\n🎉 총 {count}개 서브페이지에 '20종 회피 키워드 패턴'이 완벽히 적용되었습니다!")